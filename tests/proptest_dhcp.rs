...
proptest! {
    ...
    fn prop_discover_offer_in_pool(
        ...
        let reply = handle_discover(&pkt, pool_start, pool_end, None, server_ip);
    ...
    fn prop_request_never_panics(
        ...
        let pkt = minimal_pkt(opts, Ipv4Addr::UNSPECIFIED);
        let _ = handle_request(&pkt, pool_start, pool_end, server_ip);
    }
    ...
    fn prop_request_ack_nak(
        ...
        let reply_in = handle_request(&minimal_pkt(in_opts, Ipv4Addr::UNSPECIFIED), pool_start, pool_end, server_ip);
        ...
        let reply_out = handle_request(&minimal_pkt(out_opts, Ipv4Addr::UNSPECIFIED), pool_start, pool_end, server_ip);
